...
char auth[] = "69682e5cfe4147faa5ff5ebb4298475f";  
char cloudserver[16] = "blynk-cloud.com";
char localserver[16] = "192.168.2.106";  // IP details for the local server.
char ssid[] = "RDC_2018-2.4";                   // Your WiFi credentials.
char pass[] = "12345678";             // Password.
char OTAhost[] = "blynk";              // Optional.
//****************
